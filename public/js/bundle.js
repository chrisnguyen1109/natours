...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = "pk.eyJ1IjoiY2hyaXNuZ3V5ZW4xMTA5IiwiYSI6ImNrd2MzYmZ1bmF5NW4ydXMxeGQzc2h3YmsifQ.Ekx3dqYu5F_F9uye63O4iw";
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "".concat(url, "/api/v1/auth/logout")
            });
          ...
          case 7:
            ...
            (0, _alert.default)("error", "Error logging out! Try again.");
...
var login = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data) {
    var _response$data, response, _err$response, _err$response$data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "POST",
              url: "".concat(url, "/api/v1/auth/login"),
              data: data
            });
          ...
          case 7:
            ...
            (0, _alert.default)("error", ((_err$response = _context2.t0.response) === null || _err$response === void 0 ? void 0 : (_err$response$data = _err$response.data) === null || _err$response$data === void 0 ? void 0 : _err$response$data.message) || "Unknow error!");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            type = _args.length > 1 && _args[1] !== undefined ? _args[1] : "user";
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: "".concat(url, "/api/v1/auth/update-me"),
              data: data
            });
          ...
          case 4:
            ...
            if (res.data.status === "success" && type === "user") {
              (0, _alert.default)("success", "DATA updated successfully!");
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            } else if (res.data.status === "success" && type === "photo") {
              $(".form__user-photo").src = "/img/users/".concat(res.data.user.photo);
            }
          ...
          case 8:
            ...
            console.log(_context.t0);
            (0, _alert.default)("error", ((_err$response = _context.t0.response) === null || _err$response === void 0 ? void 0 : (_err$response$data = _err$response.data) === null || _err$response$data === void 0 ? void 0 : _err$response$data.message) || "Updated fail!");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "".concat(url, "/api/v1/auth/update-password"),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alert.default)("success", "PASSWORD updated successfully!");
            }
          ...
          case 7:
            ...
            _context2.t0 = _context2["catch"](0);
            console.log(_context2.t0);
            (0, _alert.default)("error", ((_err$response2 = _context2.t0.response) === null || _err$response2 === void 0 ? void 0 : (_err$response2$data = _err$response2.data) === null || _err$response2$data === void 0 ? void 0 : _err$response2$data.message) || "Updated fail!");
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"executeApi.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(form, btnClass, beforeMsg, actionRequest, type) {
  form.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var data, email, password, name, _name, firstName, lastName, currentPassword, newPassword, confirmPassword, afterMsg;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              data = {};
              _context2.t0 = type;
              _context2.next = _context2.t0 === "login" ? 5 : _context2.t0 === "updateUser" ? 9 : _context2.t0 === "updatePassword" ? 13 : 18;
              break;
            ...
            case 9:
              ...
              _name = _toArray(name), firstName = _name[0], lastName = _name.slice(1);
              data = {
                firstName: firstName,
            ...
            case 20:
              afterMsg = $(".".concat(btnClass)).innerHTML;
              $(".".concat(btnClass)).innerHTML = beforeMsg;
              $(".".concat(btnClass)).disabled = true;
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 2:
                        $(".".concat(btnClass)).innerHTML = afterMsg;
                        $(".".concat(btnClass)).disabled = false;
...
var stripe = Stripe("pk_test_51K0fS6DLUvUWpZhT76rW8JBD2cVVgXgCXVQ2gxljHFyArZwNdhmT5Ee1c2M8UvGFIiB59mAVauIOaGW15E9lnUuz00eoyFJAc4");
var url = window.location.origin;

var _default = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    var session, _err$response, _err$response$data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "GET",
              url: "".concat(url, "/api/v1/bookings/checkout-session/").concat(tourId)
            });
          ...
          case 9:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0);
            (0, _alert.default)("error", ((_err$response = _context.t0.response) === null || _err$response === void 0 ? void 0 : (_err$response$data = _err$response.data) === null || _err$response$data === void 0 ? void 0 : _err$response$data.message) || "Unknow error!");
...
var _executeApi = _interopRequireDefault(require("./executeApi"));
...
if (mapBox) {
  var locationsData = mapBox.dataset.locations;
  var locations = JSON.parse(locationsData);

  _mapbox.default.displayMap(locations);
}

loginForm && (0, _executeApi.default)(loginForm, "btn--save-login", "Logging...", _login.login, "login");
userDataForm && (0, _executeApi.default)(userDataForm, "btn--save-settings", "Updating data...", _updateSettings.updateUser, "updateUser");

if (userDataForm) {
  var formUpload = $(".form__upload");
  formUpload.addEventListener("change", /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return (0, _updateSettings.updateUser)(formData, "photo");
...
userPasswordForm && (0, _executeApi.default)(userPasswordForm, "btn--save-password", "Updating password...", _updateSettings.updatePassword, "updatePassword");
